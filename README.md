...
- 💻 **Full-Stack Engineering**: I enjoy crafting clean frontends with **React & Tailwind** and engineering structured, scalable backends with **Node.js & Express**.
- 🗄️ **Data Management**: Whether it’s **MongoDB, MySQL, or Oracle** — I make sure the data behaves.
- 🤖 **AI/ML & Deep Learning**: Deeply interested in teaching machines to think (or at least pretend convincingly).
